...
### 13. Возможность посмотреть список программ с возможностью пагинации и следующими фильтрациями (query params):
* `GET api/v1/WIP`
`page (int, default: 1)` – фильтрация по факультету

`size (int, default: 10, max: 100) – фильтрация по факультету`
